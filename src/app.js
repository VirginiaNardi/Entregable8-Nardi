...
try {
  ...
  //         // Ahora puedes usar userId para realizar consultas o acciones específicas del usuario
  //         res.send(`User ID: ${userId}`);
  //     } else {
  //         res.redirect('/login'); // O manejar de alguna otra manera si el usuario no está autenticado
  //     }
  // });
